...
//var_dump(array_keys($test['ReportSection'][0]['SubSection'][1]['IssueListing']['Chart']['GroupingSection'][0]));
//var_dump(array_keys($test['ReportSection'][2]['SubSection']['IssueListing']['Chart']['GroupingSection'][1]));
//var_dump($test['ReportSection'][2]['SubSection']['IssueListing']['Chart']['GroupingSection']);
