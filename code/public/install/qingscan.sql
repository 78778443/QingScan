/*
 ...
 Source Server         : 10.7.69.171
 Source Server Type    : MySQL
 Source Server Version : 50651
 Source Host           : 10.7.69.171:3306
 Source Schema         : qingscan_github

 Target Server Type    : MySQL
 Target Server Version : 50651
 File Encoding         : 65001

 Date: 11/12/2021 15:57:27
*/
...
CREATE TABLE `app_wafw00f`  (
                                ...
                                `firewall` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
                                `manufacturer` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
                                PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
CREATE TABLE `app_xray_agent_port`  (
                                        `id` int(10) NOT NULL AUTO_INCREMENT,
                                        `app_id` int(10) NOT NULL,
                                        `xray_agent_prot` int(10) NOT NULL,
                                        `create_time` datetime(0) NULL DEFAULT '2000-01-01 00:00:00',
                                        `start_up` int(1) NOT NULL DEFAULT 0,
                                        `is_get_result` int(1) NOT NULL DEFAULT 0,
                                        PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
