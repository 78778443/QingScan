    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form class="form-horizontal" action='step3.php' method='post'>
                ...
                数据库端口号：<input class="form-control" type='text' name='DB_PORT' value='33306'/><br/>
                ...
                <hr/>
                管理员：<input class="form-control" type='text' name='username' value="admin" placeholder="admin"/><br/>
                管理员密码:<input class="form-control" type='password' name='password' value="admin" placeholder="admin"/><br/>
