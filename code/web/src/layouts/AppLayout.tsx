...
const MENU: MenuGroup[] = [
  ...
  { items: [{ label: '网站扫描', path: '/webscan/targets', icon: Globe }] },
  {
    title: '扫描结果',
    items: [
      { label: 'Web漏洞检测', path: '/webscan/xray', icon: Radar },
      { label: '通用漏洞扫描', path: '/webscan/nuclei', icon: Shield },
      { label: 'SQL注入检测', path: '/webscan/sqlmap', icon: Database },
      { label: '漏洞验证', path: '/webscan/vulmap', icon: Bug },
      { label: '目录扫描', path: '/webscan/dirmap', icon: FolderSearch },
      { label: '指纹识别', path: '/webscan/whatweb', icon: Globe },
    ],
  },
  {
    title: '资产管理',
...
const TITLES: Record<string, string> = {
  ...
  '/webscan/xray': 'Web漏洞检测',
  '/webscan/nuclei': '通用漏洞扫描',
  '/webscan/sqlmap': 'SQL注入检测',
  '/webscan/vulmap': '漏洞验证',
  '/webscan/dirmap': '目录扫描',
  '/webscan/whatweb': '指纹识别',
  '/asm/host': '主机资产',
  '/asm/port': '端口资产',
  '/asm/domain': '域名资产',
  '/asm/subdomain': '子域名',
