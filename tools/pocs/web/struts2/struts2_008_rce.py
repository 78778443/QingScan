...
class DemoPOC(POCBase):
    ...
    version = '1'
    appName = 'Struts2'
    appVersion = '2.1.0 - 2.3.1'
    name = 'Struts2-008远程代码执行'
    desc = '''Struts2-008远程代码执行'''
    pocDesc = '''Struts2-008远程代码执行'''
    vulType = VUL_TYPE.CODE_EXECUTION
    category = POC_CATEGORY.EXPLOITS.WEBAPP
    protocol = POC_CATEGORY.PROTOCOL.HTTP
    references = ['https://github.com/vulhub/vulhub/blob/master/struts2/s2-008/README.zh-cn.md']
